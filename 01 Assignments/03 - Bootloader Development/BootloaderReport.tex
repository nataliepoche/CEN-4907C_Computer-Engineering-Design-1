...
\usepackage{subcaption} % Combines multiple images into a single figure float
\usepackage{float}      % Forces exact positioning with [H]
...
\begin{enumerate}
    ...
    % Single figure container forces all four screenshots to remain together in a 2x2 grid
    \begin{figure}[H]
        \centering
        \begin{subfigure}[b]{0.48\textwidth}
            \centering
            \includegraphics[width=\linewidth]{images/i386_image_commands.png}
            \caption{Setup for i386 emulator}
            \label{fig:i386_setup}
        \end{subfigure}
        \hfill
        \begin{subfigure}[b]{0.48\textwidth}
            \centering
            \includegraphics[width=\linewidth]{images/i386_image.png}
            \caption{Results for i386 emulator}
            \label{fig:i386_results}
        \end{subfigure}
        ...
        \begin{subfigure}[b]{0.48\textwidth}
            \centering
            \includegraphics[width=\linewidth]{images/x86_image_commands.png}
            \caption{Setup for x86\_64 emulator}
            \label{fig:x86_64_setup}
        \end{subfigure}
        \hfill
        \begin{subfigure}[b]{0.48\textwidth}
            \centering
            \includegraphics[width=\linewidth]{images/x86_image.png}
            \caption{Results for x86\_64 emulator}
            \label{fig:x86_64_results}
        \end{subfigure}

        \caption{x86 and x86\_64 emulator setup and execution results.}
        \label{fig:x86_emulation_all}
    \end{figure}
...
\begin{enumerate}
  \setcounter{enumi}{2}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.6\linewidth]{images/arm_image.png} % images must be in the same directory for proper compilation. overleaf makes this very simple 
        \caption{ARM with Akita and Raspi2 set up and result emulation}
...
\vspace{10pt}
\noindent \textbf{Screencast Link:} \url{https://youtu.be/C69_gjl16MY}

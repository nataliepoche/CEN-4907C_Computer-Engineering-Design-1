...
\section{Technical}
Explain, in your own words, how the scale settings for voltage and time affect an oscilloscope’s capturing of a waveform. (A good response should identify, describe, and explain the inner workings of an oscilloscope.)
